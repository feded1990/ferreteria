...
public class Clientes extends javax.swing.JFrame {
    ...
    List<String> columnas = new ArrayList<>(Arrays.asList("DNI", "Nombre", "Apellido"));
    
    public Clientes(PanelPrincipal panelPrincipal) {
        setUndecorated(true);
        initComponents();
    ...
    private void textoDNIKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textoDNIKeyReleased
        if (textoDNI.getText().equals("")) {
            ...
            tabla.setModel(TablaUtils.recargarTabla(columnas, db.listarClientesFiltro(dni)));
        }
    ...
    private void botonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonActualizarActionPerformed
        ...
        if(tabla.getSelectedRow()+1 > 0){
            ...
            cliente.setDNI(Integer.parseInt(tabla.getValueAt(filaSeleccionada, 0).toString()));
            cliente.setNombre(tabla.getValueAt(filaSeleccionada, 1).toString());
            cliente.setApellido(tabla.getValueAt(filaSeleccionada, 2).toString());
            
            ActualizarClientes jActualizarCliente = new ActualizarClientes(this,cliente);
            jActualizarCliente.setVisible(true);
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        AgregarCliente jAgregarCliente = new AgregarCliente(this);
        jAgregarCliente.setLocationRelativeTo(null);
        jAgregarCliente.setVisible(true);
    }//GEN-LAST:event_botonAgregarActionPerformed

    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        if(tabla.getSelectedRow()+1>0){           
            int filaSeleccionada = tabla.getSelectedRow();                
            int clienteId = Integer.parseInt(tabla.getValueAt(filaSeleccionada, 0).toString());
    ...
    public void recargarTabla(){
        tabla.setModel(TablaUtils.recargarTabla(columnas, db.listarClientes()));
    }
